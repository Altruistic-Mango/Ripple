...
curl -H "Content-Type:application/json" -X POST -d '{"x": "-122.515", "y": "37.615", "photoId": "666", "userId": "2343289", "TTL": "55", "radius": "55", "photoURL" : "http://localh"}' http://localhost:3000/photos/newPhoto
...
curl -H "Content-Type: application/json" -X POST -d '{"x": "-122.515" , "y" : "37.615"}' http://localhost:3000/gps/distance
    ...
    //   this.put({x: -122.515, y: 37.615, userId: 3516227});
    //   this.put({x: -122.515, y: 37.619, userId: 9429623});
    //   this.put({x: -122.515, y: 37.618, userId: 1764192});
    // };
